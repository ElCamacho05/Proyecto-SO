...
class TerminalSO:
    def __init__(self, terminal_output, frame_terminal, boton_tarea):
    ...
    def escribir(self, texto):
        try:
            ...
            pass  # Ignora si ya fue destruido
...
def crear_terminal_contenida(contenedor, barra_tareas):
    ...
    terminal = TerminalSO(salida, frame_terminal, boton_tarea)
